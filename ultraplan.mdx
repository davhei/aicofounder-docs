---
title: "Ultraplan"
description: "Ultraplan is ai cofounder's strategic planning agent. It assesses your project, identifies the single most important blocker, and creates a plan to break through it."
"og:image": "/images/ultraplan-in-progress.png"
keywords: ["ai cofounder", "aicofounder", "AI planning", "strategic planning", "product roadmap", "startup planning"]
---

Ultraplan is how ai cofounder does strategic planning. It's a dedicated planning agent that assesses the current state of your project, identifies the single most important thing blocking progress, and creates a specific plan to address it.
...
<img src="/images/ultraplan-in-progress.png" alt="Ultraplan in progress" className="w-full rounded-lg" style={{border: '1px solid #b3b3b3'}} />
...
<img src="/images/ultraplan-plan-document.png" alt="Plan document on canvas" className="w-full rounded-lg" style={{border: '1px solid #b3b3b3'}} />
...
<img src="/images/ultraplan-collaboration.png" alt="AI discussing ultraplan results" className="w-full rounded-lg" style={{border: '1px solid #b3b3b3'}} />
...
- **After research.** When [research](/research) produces findings that change the picture, ultraplan incorporates the new information.
