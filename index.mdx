---
title: "Welcome"
description: "Buildpad is an AI for building products. Describe what you want to create and it helps you think it through, research it, build it, and move forward."
...
<div className="px-4 py-16 lg:py-32 lg:pb-16 max-w-3xl mx-auto">
  ...
  <div className="max-w-xl mx-auto px-4 mt-4 text-lg text-center text-gray-500">
    Buildpad is an AI for building products. Describe what you want to create and it will help you think it through, research it, build it, and move you forward.
  </div>
